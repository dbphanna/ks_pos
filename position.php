              ...
              <hr>
                       ...
                       <form class="form-horizontal">
                          <div class="form-group">
                             ...
                             <div class="col-sm-9">
                               <input type="text" class="form-control" id="email" placeholder="ឈ្មោះក្រុមទំនិញ">
                             </div>
                          </div>
                          <div class="form-group">
                        ...
                        <span class="sr-only">Loading...</span>Action</th>
    							...
    							<tbody>
    									<tr>
    											...
    											<td></td>
    											<td>
    						<a href="edit_position.php" class="btn btn-success btn-xs" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
