				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-body">
							<h2 class="text-primary">Paper Type</h2>
										 ...
										 <div class="modal-body">
					                       <form class="form-horizontal">
					                          <div class="form-group">
					                             <label class="control-label col-sm-3" for="email">Paper Type:</label>
					                             <div class="col-sm-9">
  							...
  							<table id="example" class="display" cellspacing="0" width="100%">
    							...
    							<tbody>
    									<tr>
    											...
    											<td></td>
    											<td>
    													<a href="edit_paper_type.php" class="btn btn-success btn-xs" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
